// 3. Create two shader programs
//	  where the second program uses
//    the different fragment shader
//    outputs yellow color. The result
//    is two triangles - orange and yellow
